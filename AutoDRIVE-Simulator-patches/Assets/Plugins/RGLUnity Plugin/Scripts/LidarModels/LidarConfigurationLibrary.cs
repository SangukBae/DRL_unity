    ...
    public static class LidarConfigurationLibrary
    {
        public static readonly Dictionary<LidarModel, LidarConfiguration> ByModel =
            new Dictionary<LidarModel, LidarConfiguration>
            {
                ...
                {LidarModel.OusterOS1_32, OusterOS1_32},
                {LidarModel.OusterOS1_64, OusterOS1_64},
                {LidarModel.OusterOS1_128, OusterOS1_128},
            };
        ...
        public static LidarConfiguration OusterOS1_32 => new LidarConfiguration
        {
            laserArray = LaserArrayLibrary.OusterOS1_32,
        ...
        // Ouster OS1-128: 128 channels, 45deg vertical FOV (+/-22.5deg), 0.35deg vertical resolution
        // horizontalSteps=1024 for ~0.35deg horizontal resolution, maxRange=200m
        public static LidarConfiguration OusterOS1_128 => new LidarConfiguration
        {
